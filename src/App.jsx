    ...
    <div className="App">
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path="/map" element={<>{/* 이쪽은 로그인 변환용으로 일단 냅둠 */}<Nav setStructure={setStructure} /><Map structure={structure} floor={floor} setFloor={setFloor} setStructure={setStructure} /></>} />
